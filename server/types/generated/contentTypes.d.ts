...
export interface ApiAddressAddress extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    address_detail: Schema.Attribute.Text & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    is_shadowban: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    root_comment: Schema.Attribute.Relation<
      'manyToOne',
      'api::comment.comment'
    >;
    sub_comments: Schema.Attribute.Relation<
      'oneToMany',
      'api::comment.comment'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiDiscountDiscount extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    discount_name: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    order_list: Schema.Attribute.Relation<
      'oneToOne',
      'api::order-list.order-list'
    >;
    publishedAt: Schema.Attribute.DateTime;
    reach: Schema.Attribute.Decimal & Schema.Attribute.Required;
    subtract: Schema.Attribute.Decimal & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dine_icon: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    goods_img: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    outside_icon: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vip_page_bg: Schema.Attribute.Media<'images'>;
  };
}

export interface ApiMenuClassMenuClass extends Struct.CollectionTypeSchema {
  collectionName: 'menu_classes';
  info: {
    displayName: 'MenuClass';
    pluralName: 'menu-classes';
    singularName: 'menu-class';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    class_icon: Schema.Attribute.Media<'images'>;
...
export interface ApiMenuFlavorMenuFlavor extends Struct.CollectionTypeSchema {
  collectionName: 'menu_flavors';
  info: {
    displayName: 'MenuFlavor';
    pluralName: 'menu-flavors';
    singularName: 'menu-flavor';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    flavor_list: Schema.Attribute.JSON & Schema.Attribute.Required;
    flavor_name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 10;
...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::menu.menu'> &
      Schema.Attribute.Private;
    menu_class: Schema.Attribute.Relation<
      'manyToOne',
      'api::menu-class.menu-class'
    >;
    menu_desc: Schema.Attribute.Text;
    menu_flavors: Schema.Attribute.Relation<
      'manyToMany',
      'api::menu-flavor.menu-flavor'
    >;
    menu_img: Schema.Attribute.Media<'images'>;
    menu_name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    menu_number: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    menu_price: Schema.Attribute.Decimal & Schema.Attribute.Required;
    need_vip: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOrderListOrderList extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    order_list: Schema.Attribute.JSON & Schema.Attribute.Required;
    order_mode: Schema.Attribute.Enumeration<
      ['outside', 'takeout', 'dine_in']
    > &
      Schema.Attribute.Required &
    ...
    order_status: Schema.Attribute.Enumeration<
      ['production', 'delivering', 'pick_up', 'finished', 'canceled']
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiStoreStore extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    store_address: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 1;
    ...
    store_opening: Schema.Attribute.Time & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
export interface ApiVipVip extends Struct.CollectionTypeSchema {
  collectionName: 'vips';
  info: {
    displayName: 'VIP';
    pluralName: 'vips';
  ...
  attributes: {
    ...
    deadline: Schema.Attribute.DateTime & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::vip.vip'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    vip: Schema.Attribute.Relation<'oneToOne', 'api::vip.vip'>;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::menu-class.menu-class': ApiMenuClassMenuClass;
      'api::menu-flavor.menu-flavor': ApiMenuFlavorMenuFlavor;
